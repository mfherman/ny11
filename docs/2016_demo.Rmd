...
# make a map of reichard/donovan margin 2016, highlight ed +-10pt
tmap_mode("view")
tm_shape(cong_2016_to_map, name = "% Bachelors") +
  tm_fill(
    col = "pop_ba_pct",
    palette = "Blues",
    style = "cont",
...
# make a map of reichard/donovan margin 2016, highlight ed +-10pt
tmap_mode("view")
tm_shape(cong_2016_to_map, name = "% Renters") +
  tm_fill(
    col = "pop_rent_pct",
    palette = "Greens",
    style = "cont",

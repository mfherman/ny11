...
library(tmap)
library(DT)
opts_chunk$set(echo = FALSE, cache = TRUE, cache.path = here("cache/2014_cong/"))
```
...
# make a map of recchia/grimm margin 2014, highlight ed +-10pt
tmap_mode("view")
tm_shape(cong_2014_to_map, name = "2014 Congressional") +
  tm_fill(
    col = "margin",
    palette = "RdBu",
    style = "cont",
